...
loc_slider_group = [0.775 0.05 0.20 0.25];
...
txt_fixed_height = uicontrol(group_sliders,...
                                'style', 'text',...
                                'units', 'normalized',...
                                'position', [0.75 0.70 0.22 0.19],...
                                'String',sprintf('Fix H:\n %i', fixed_corr_dimen(1)));
slider_fixed_width = uicontrol(group_sliders,...
                                'style', 'slider',...
                                'units', 'normalized',...
                                'position', [0.05 0.50 0.70 0.19],...
...
txt_fixed_width = uicontrol(group_sliders,...
                                'style', 'text',...
                                'units', 'normalized',...
                                'position', [0.75 0.50 0.22 0.19],...
                                'String',sprintf('Fix W:\n %i', fixed_corr_dimen(2)));
slider_moving_height = uicontrol(group_sliders,...
                                'style', 'slider',...
                                'units', 'normalized',...
                                'position', [0.05 0.30 0.70 0.19],...
                                'min', 10,...
...
txt_moving_height = uicontrol(group_sliders,...
                                'style', 'text',...
                                'units', 'normalized',...
                                'position', [0.75 0.30 0.22 0.19],...
                                'String',sprintf('Move H:\n %i', moving_sub_dimen(1)));
slider_moving_width = uicontrol(group_sliders,...
                                'style', 'slider',...
                                'units', 'normalized',...
                                'position', [0.05 0.10 0.70 0.19],...
                                'min', 10,...
...
while(run==1)
    ...
    title(sprintf('Current stress = %0.3fMPa \t\t Current Strain = %0.3f%%', curr_stress, curr_strain_xx*100));
    drawnow
    clear title  
